...
CREATE TABLE ADMIN_ACTION_LOG (
    ADMIN_LOG_ID NUMBER PRIMARY KEY,
    ADMIN_ID NUMBER REFERENCES USERS(USER_ID),
    ACTION_TYPE VARCHAR2(50) NOT NULL,
    TARGET_DEVICE_IMEI VARCHAR2(20),
...
CREATE SEQUENCE SEQ_PROVIDER START WITH 1; 
CREATE SEQUENCE SEQ_ALERT START WITH 1;   
CREATE SEQUENCE SEQ_ADMIN_LOG START WITH 1; 
```
<br/><br/>
